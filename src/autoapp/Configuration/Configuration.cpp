...
void Configuration::load() {
  ...
  try {
    ...
    handednessOfTrafficType_ = static_cast<HandednessOfTrafficType>(
        settings
            .value("HandednessOfTraffic",
                   static_cast<int>(HandednessOfTrafficType::Right))
            .toInt());
    settings.endGroup();
    ...
    playerButtonControl_ =
        settings.value("PlayerButtonControl", false).toBool();
  ...
  void Configuration::reset() {
    ...
    handednessOfTrafficType_ = HandednessOfTrafficType::Right;
  ...
  void Configuration::setHandednessOfTrafficType(
      HandednessOfTrafficType value) {
      ...
      while (inFile.good()) {
        ...
        if (line[0] != '#') {
                                        ...
                                        // not found
          {
            ...
            value.replace("\"", "");
            OPENAUTO_LOG(debug) << "[Configuration] CS param found: "
  ...
  void Configuration::readButtonCodes(boost::property_tree::ptree & iniConfig) {
    ...
    this->insertButtonCode(iniConfig, cInputNavButtonKey,
                           aap_protobuf::service::media::sink::message::
  ...
  void Configuration::writeButtonCodes(boost::property_tree::ptree &
                                       iniConfig) {
    ...
    iniConfig.put<bool>(cInputPreviousTrackButtonKey,
                        std::find(buttonCodes_.begin(), buttonCodes_.end(),
                                  aap_protobuf::service::media::sink::message::
                                      KeyCode::KEYCODE_MEDIA_PREVIOUS) !=
                            buttonCodes_.end());
    iniConfig.put<bool>(cInputHomeButtonKey,
                        std::find(buttonCodes_.begin(), buttonCodes_.end(),
                                  aap_protobuf::service::media::sink::message::
                                      KeyCode::KEYCODE_HOME) !=
                            buttonCodes_.end());
    iniConfig.put<bool>(cInputPhoneButtonKey,
                        std::find(buttonCodes_.begin(), buttonCodes_.end(),
                                  aap_protobuf::service::media::sink::message::
    ...
    iniConfig.put<bool>(cInputScrollWheelButtonKey,
                        std::find(buttonCodes_.begin(), buttonCodes_.end(),
                                  aap_protobuf::service::media::sink::message::
                                      KeyCode::KEYCODE_ROTARY_CONTROLLER) !=
                            buttonCodes_.end());
    iniConfig.put<bool>(cInputBackButtonKey,
                        std::find(buttonCodes_.begin(), buttonCodes_.end(),
                                  aap_protobuf::service::media::sink::message::
