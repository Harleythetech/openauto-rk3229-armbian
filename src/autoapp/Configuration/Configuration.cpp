...
void Configuration::load() {
  ...
  try {
    ...
    mp3MasterPath_ =
        iniConfig.get<std::string>(cGeneralMp3MasterPathKey, "/media/MYMEDIA");
    ...
    enablePlayerControl_ =
        iniConfig.get<bool>(cInputEnablePlayerControlKey, false);
    ...
    wirelessProjectionEnabled_ =
        iniConfig.get<bool>(cBluetoothWirelessProjectionEnabledKey, true);

    bluetoothAdapterAddress_ =
        iniConfig.get<std::string>(cBluetoothAdapterAddressKey, "");

    _audioChannelEnabledMedia =
        iniConfig.get<bool>(cAudioChannelMediaEnabled, true);
    _audioChannelEnabledGuidance =
        iniConfig.get<bool>(cAudioChannelGuidanceEnabled, true);
    _audioChannelEnabledSystem =
        iniConfig.get<bool>(cAudioChannelSystemEnabled, true);
    _audioChannelEnabledTelephony =
        iniConfig.get<bool>(cAudioChannelTelephonyEnabled, true);

    audioOutputDeviceName_ =
        iniConfig.get<std::string>(cAudioOutputDeviceName, "");
...
void Configuration::reset() {
  ...
  audioOutputDeviceName_ = ""; // Empty means use default device
...
void Configuration::save() {
  ...
  iniConfig.put<std::string>(cBluetoothAdapterAddressKey,
                             bluetoothAdapterAddress_);
  iniConfig.put<bool>(cBluetoothWirelessProjectionEnabledKey,
                      wirelessProjectionEnabled_);

  iniConfig.put<bool>(cAudioChannelMediaEnabled, _audioChannelEnabledMedia);
  iniConfig.put<bool>(cAudioChannelGuidanceEnabled,
                      _audioChannelEnabledGuidance);
  iniConfig.put<bool>(cAudioChannelSystemEnabled, _audioChannelEnabledSystem);
  iniConfig.put<bool>(cAudioChannelTelephonyEnabled,
                      _audioChannelEnabledTelephony);
  iniConfig.put<std::string>(cAudioOutputDeviceName, audioOutputDeviceName_);
